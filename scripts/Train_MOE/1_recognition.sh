...
deepspeed --include localhost:0,1,2 --master_port 29600 llava/train/train_mem_MOE.py \
    ...
    --pretrain_mm_mlp_adapter /work/09359/mf0463/ls6/CL-MoE/checkpoint/llava-v1.5-mlp2x-336px-pretrain-vicuna-7b-v1.5/mm_projector.bin \
    --version v1 \
    --data_path /work/09359/mf0463/ls6/CL-MoE/data/CL4VQA/train/train_q_recognition.json \
