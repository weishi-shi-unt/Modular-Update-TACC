...
deepspeed --include localhost:0,1,2 --master_port 29600 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path ./checkpoints/CL4VQA/commonsense/llava-1.5-7b-lora \
    --version v1 \
    --data_path /work/09359/mf0463/ls6/CL-MoE/data/CL4VQA/train/train_q_count.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/CL4VQA/Only_Pretrain_1.5_MOE_2/count/llava-1.5-7b-lora \
    --num_train_epochs 1 \
